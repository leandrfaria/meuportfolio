...
export default function ProjectsPrimary({ id = "projetos", title = "projetos principais", items }: Props) {
  return (
    <section id={id} className="mx-auto max-w-5xl px-5 pt-20 md:pt-24 lg:pt-28 pb-10 md:pb-12 lg:pb-14">
