  ...
  return (
    ...
    >
      ...
      <div className="mt-8 flex flex-wrap gap-3">
        <a
          href="#projetos"
          className="rounded-md border border-white/15 bg-white/[0.02] px-5 py-2.5 text-sm font-semibold text-brand-white transition hover:border-brand-green/70 hover:text-brand-green"
        >
          ver projetos
        </a>
        <a
          href="#contatos"
          className="rounded-md bg-brand-green px-5 py-2.5 text-sm font-semibold text-brand-black transition hover:brightness-110"
        >
          falar comigo
        </a>
      </div>
